...
struct
  ...
  val cairo_restore =
    _import "cairo_restore" : cairo_t -> ()

  val cairo_fill =
    _import "cairo_fill" : cairo_t -> ()

  val cairo_stroke =
    _import "cairo_stroke" : cairo_t -> ()
  
  val cairo_paint =
    _import "cairo_paint" : cairo_t -> ()

  val cairo_set_source_rgb =
    _import "cairo_set_source_rgb" : (cairo_t, real, real, real) -> ()
  ...
  val cairo_rectangle =
    _import "cairo_rectangle" : (cairo_t, real, real, real, real) -> ()

  val cairo_arc =
    _import "cairo_arc" : (cairo_t, real, real, real, real, real) -> ()
